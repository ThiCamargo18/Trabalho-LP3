...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("E_COMMERCE");

        jLabel3.setText("Sistema funcionarios e gerente");

        jLabel4.setText("Sistema clientes");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        AplicacaoEmpresa aplicacaoEmpresa = new AplicacaoEmpresa();
        aplicacaoEmpresa.setVisible(true);
        dispose();
